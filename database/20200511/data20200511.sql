...
-- Dumping data for table db_demo_t3h.dbo_cart: ~4 rows (approximately)
DELETE FROM `dbo_cart`;
...
DELETE FROM `dbo_product_entity`;
...
INSERT INTO `dbo_product_image` (`product_image_id`, `product_id`, `link`, `created_date`) VALUES
	(1, 1, '/no_image.jpg', '2020-05-11 11:18:46'),
	(2, 1, '/no_image.jpg', '2020-05-11 11:20:07'),
	(3, 1, '/no_image.jpg', '2020-05-11 11:20:07'),
	(4, 4, '/no_image.jpg', '2020-05-11 11:20:07'),
	(5, 5, '/no_image.jpg', '2020-05-11 11:20:07');
/*!40000 ALTER TABLE `dbo_product_image` ENABLE KEYS */;

-- Dumping data for table db_demo_t3h.dbo_role: ~2 rows (approximately)
DELETE FROM `dbo_role`;
...
INSERT INTO `dbo_user` (`user_id`, `user_name`, `email`, `avatar`, `name`, `gender`, `address`, `password_hash`, `phone_number`, `created_date`) VALUES
	(1, 'trieu.ngoquang', 'ngoquangtrieu99tb@gmail.com', NULL, NULL, 0, NULL, '$2a$10$qWM2dpyGZjla.XcdNGQcduX.mBqFY9chHMjPcDjyb14aKwEPmMe2W', 0, '2020-05-04 14:16:16'),
	(2, 'trang.dothi', 'trang.dothi@vti.com.vn', NULL, NULL, 0, NULL, '$2a$10$XPqnsZ.Q.1KprnC0SaZR4uhGWYdzLPlt96e/MgsbDYHHWbinAot/y', 0, '2020-05-04 14:18:48');
/*!40000 ALTER TABLE `dbo_user` ENABLE KEYS */;

-- Dumping data for table db_demo_t3h.dbo_user_role: ~2 rows (approximately)
DELETE FROM `dbo_user_role`;
